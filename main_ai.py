...
class Game(object):
    ...
    def finish(self, time):
        ...
        while run:
            ...
            button_play = Button(130, 250, 250, 70, self.screen, center=False)
            button_play.add_text('Play again')
            button_play.render()

            button_menu = Button(430, 250, 250, 70, self.screen, center=False)
            button_menu.add_text('Menu')
            button_menu.render()
